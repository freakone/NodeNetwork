...
void rfm73_init( void ){
   ...
   RCC->APB1ENR |=  RCC_APB1ENR_SPI2EN;     //enalble rcc spi2
   GPIOB->MODER |= GPIO_MODER_MODER11_0 | GPIO_MODER_MODER12_0 | GPIO_MODER_MODER13_1 | GPIO_MODER_MODER14_1 | GPIO_MODER_MODER15_1;
   GPIOB->OSPEEDR |= GPIO_OSPEEDER_OSPEEDR11_1  | GPIO_OSPEEDER_OSPEEDR11_0  | GPIO_OSPEEDER_OSPEEDR12_1 | GPIO_OSPEEDER_OSPEEDR13_1 | GPIO_OSPEEDER_OSPEEDR14_1 | GPIO_OSPEEDER_OSPEEDR15_1 |
   ...
   SPI2->CR1 =  SPI_CR1_MSTR | SPI_CR1_SSM | SPI_CR1_SSI | SPI_CR1_BR;
